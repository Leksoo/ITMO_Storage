package ru.ifmo.rain.feponov.concurrent;
...
public class IterativeParallelism implements ListIP {
    ...
    private <T, U> List<U> applyAndFlatMap(int threads, List<? extends T> list, Function<Stream<? extends T>, Stream<? extends U>> func) throws InterruptedException {
    ...
    public <T> List<T> filter(int threads, List<? extends T> list, Predicate<? super T> predicate) throws InterruptedException {
        return applyAndFlatMap(threads, list, stream -> stream.filter(predicate));
    }

    @Override
    public <T, U> List<U> map(int threads, List<? extends T> list, Function<? super T, ? extends U> function) throws InterruptedException {
        return applyAndFlatMap(threads, list, stream -> stream.map(function));
