...
class Pred(val str: String, val terms: ArrayList<Expression>) : Expression {
...
//            terms.forEach { set.addAll(it.freeVars(busyVariables)) }
//            return set
//        }
//    }
    ...
    override fun diff(other: Expression, res: ArrayList<Pair<Expression, Expression>>) {
        if (this.javaClass == other.javaClass && other is Pred) {
